...
// @ts-nocheck
  ...
  import AccountSavings from '../../../components/AccountSavings.svelte';
</script>

<svelte:head>
  <title>Savings - Reel Bank</title>
</svelte:head>

<section class="mt-8 m-4">
  <h1 class="text-2xl font-bold">My Savings</h1>
  <p>
    Here, you can view a list of all the savings accounts that you have with Reel Bank. You can
    filter the savings accounts by account type.
  </p>
</section>

<hr />

<AccountSavings balance={data.balance} />

<section>
  <div class="bg-gray-100 sm:py-32 lg:pt-8 rounded-xl">
      ...
      <div class="mt-20 max-w-lg sm:mx-auto md:max-w-none">
        <div class="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-12 md:gap-y-16">
          <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
            ...
            <div class="sm:min-w-0 sm:flex-1">
              <p class="text-lg font-semibold leading-8 text-gray-900">
                Earn up to 1.5% back on every purchase
              </p>
          ...
          <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
            ...
            <div class="sm:min-w-0 sm:flex-1">
              <p class="text-lg font-semibold leading-8 text-gray-900">Protect Your Money</p>
              <p class="mt-2 text-base leading-7 text-gray-600">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit
                perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.
              </p>
          ...
          <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
            ...
            <div class="sm:min-w-0 sm:flex-1">
              <p class="text-lg font-semibold leading-8 text-gray-900">Fraud Detection</p>
              <p class="mt-2 text-base leading-7 text-gray-600">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit
                perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.
              </p>
          ...
          <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
            ...
            <div class="sm:min-w-0 sm:flex-1">
              <p class="text-lg font-semibold leading-8 text-gray-900">Safety When Travelling</p>
              <p class="mt-2 text-base leading-7 text-gray-600">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit
                perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.
              </p>
